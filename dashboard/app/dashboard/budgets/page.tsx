    ...
    <div>
      <div className="page-header-bar">
        <div>
          ...
          <p style={{ fontSize: '13px', color: 'var(--text-3)', marginTop: '2px' }}>Set spending limits to control costs</p>
        </div>
      ...
      {loading ? (
        ...
        <div style={{ padding: 'clamp(16px, 4vw, 24px) clamp(16px, 4vw, 36px) 48px' }}>
          <EmptyState icon={PiggyBank} title="No budgets configured" description="Create a budget to set spending limits." />
        </div>
      ) : (
            ...
            <div className="card" style={{ marginBottom: '20px' }}>
              <div className="card-header" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                ...
                <button
                  ...
                  onClick={() => { setShowCreateForm(false); setCreateError(''); setBudgetLimit(''); setBudgetPeriod('monthly'); setBudgetHardCap(true); setBudgetAlertThreshold('0.8'); }}
                >
                  Cancel
                </button>
              </div>
                  ...
                  <div key={b.id}>
                    <div className="setting-row">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div style={{ fontSize: '14px' }}>{periodLabel}</div>
