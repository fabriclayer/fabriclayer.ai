...
const PLANS = [
  {
    ...
    name: 'Free',
    price: 0,
    features: ['1,000 requests/day', '1 wallet', 'Community support'],
  },
  {
    id: 'BUILDER',
    name: 'Builder',
    price: 9,
    features: ['5,000 requests/day', '3 wallets', 'Email support'],
  },
  {
    id: 'PRO',
    name: 'Pro',
    price: 39,
    features: ['15,000 requests/day', '10 wallets', 'Priority support'],
  },
  {
    id: 'TEAM',
    name: 'Team',
    price: 149,
    features: ['100,000 requests/day', '50 wallets', 'Dedicated support'],
  },
];
