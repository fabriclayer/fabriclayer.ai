  ...
  return (
    <div>
      <div className="page-header-bar">
        <div>
          <h1>Wallets</h1>
          <p style={{ fontSize: '13px', color: 'var(--text-3)', marginTop: '2px' }}>Managed USDC wallets on Base L2 for payments</p>
        </div>
...
>
              ...
              <div className="card-body">
                ...
                <button
                  ...
                  style={{ padding: '9px 20px', fontWeight: 600, opacity: creating ? 0.4 : 1 }}
                  disabled={creating}
                  ...
                  return (
                    <div key={w.agentId} className="wallet-row">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div style={{ fontSize: '14px' }}>{w.agentName || 'Wallet'}</div>
