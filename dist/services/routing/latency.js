 ...
 */
export async function recordLatency(providerId, category, latencyMs, success) {
 ...
 */
export async function getLatencyStats(providerId) {
    try {
        const key = `${LATENCY_PREFIX}${providerId}`;
 ...
 */
async function updateProviderMetrics(providerId, category) {
