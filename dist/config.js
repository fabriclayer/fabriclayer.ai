...
export const USDC_ADDRESS = (process.env.USDC_ADDRESS || '0x036CbD53842c5426634e7929541eC2318f3dCF7e'); // Base Sepolia USDC
export const FABRIC_IDENTITY_ADDRESS = (process.env.FABRIC_IDENTITY_ADDRESS || '0xa87df8b26393e48173530648a0baf7495bd6a66a');
export const FABRIC_REGISTRY_ADDRESS = (process.env.FABRIC_REGISTRY_ADDRESS || '0x1ed343eec726ac3212d3ffe7c456617cf561b9f2');
// ─── Wallet Management ───
export const FABRIC_OPERATOR_KEY = process.env.FABRIC_OPERATOR_KEY || ''; // Private key for fee collection
export const FABRIC_FEE_WALLET = (process.env.FABRIC_FEE_WALLET || '0x0000000000000000000000000000000000000000');
// ─── Gas ───
...
export const PLAN_PRICES_USD = { FREE: 0, BUILDER: 9, PRO: 39, TEAM: 149 };
// ─── Trust Score Cache ───
